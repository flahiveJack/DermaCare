...
public class AddPostActivity extends AppCompatActivity {
    ...
    private EditText mCaptionText, mAddress, mPhone, mWebsite;;
   ...
   // private TextView mAddress, mPhone, mWebsite;

    private String address, phone, website;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebsite = findViewById(R.id.website_text);
        ...
        noteRef = firestore.collection("Users").document(currentUserId);
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if (documentSnapshot.exists()){
                            ...
                            Toast.makeText(AddPostActivity.this, "Document does not exist", Toast.LENGTH_SHORT).show();
                        }
